...
class ChangeDecoder(nn.Module):
    def __init__(self, encoder_dims, channel_first, norm_layer, ssm_act_layer, mlp_act_layer, cm_type="mlp", **kwargs):
        ...
        self.st_block_41 = nn.Sequential(
            ...
            VSSBlock(hidden_dim=128, drop_path=0.2, norm_layer=norm_layer, channel_first=channel_first,
                ...
                gmlp=kwargs['gmlp'], use_checkpoint=kwargs['use_checkpoint'], cm_type=cm_type),
