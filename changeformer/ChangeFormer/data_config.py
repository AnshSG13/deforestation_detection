class DataConfig:
    ...
    def get_data_config(self, data_name):
        ...
        if data_name == 'LEVIR':
            ...
            self.root_dir = '/work/pi_jaimedavila_umass_edu/asadhgauri_umass_edu/data/chips/'
        else:
...
if __name__ == '__main__':
    data = DataConfig().get_data_config(data_name='deforestation')
    print("Data name:", data.data_name)
    print("Root directory:", data.root_dir)
    print("Label transform:", data.label_transform)
    
    import os
    if os.path.exists(data.root_dir):
        print("Root directory exists. Its contents are:")
        print(os.listdir(data.root_dir))
    else:
        print("Root directory does not exist. Check the path!")
